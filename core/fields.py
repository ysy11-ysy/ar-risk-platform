...
EXTRA_ITEMS = [
    ...
    ("top5_customer_sales", "前五大客户销售额合计(万元)"),
    ("new_customer_sales",  "本年新增前五大客户销售额合计(万元,年报未披露则 null)"),
    ("customer_supplier_overlap", "客户与供应商重叠主体家数(年报披露『无重叠』填 0,未披露则 null)"),
    ("y_m3_rev",            "三年前(审计年度-3)营业收入(万元)"),
